...
<a class="button2" href="/cakephp/StoreAdmin/logout"style="text-decoration:none;">logout</a>
    ...
    <table>
      ...
      <td>
        ...
        <td>
          <br>
          <br>
          <a class="button2"style="text-decoration:none;" href="/cakephp/StoreApp/edit?id=<?php echo $app['StoreApp']['id'];?>">EDIT</a>
        </td>
      </tr>
    </ul>
  </table>
